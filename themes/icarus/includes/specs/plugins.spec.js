...
module.exports = {
    ...
    gallery: {
        [type]: 'boolean',
        [doc]: 'Enable the lightGallery and Justified Gallery plugins\nhttps://blog.zhangruipeng.me/hexo-theme-icarus/Plugins/General/gallery-plugin/',
        [defaultValue]: true
    },
    'outdated-browser': {
        [type]: 'boolean',
    ...
    mathjax: {
        [type]: 'boolean',
        [doc]: 'Enable the MathJax plugin\nhttps://blog.zhangruipeng.me/hexo-theme-icarus/Plugins/General/mathjax-plugin/',
        [defaultValue]: true
    },
    'back-to-top': {
        [type]: 'boolean',
    ...
    'google-analytics': {
        [type]: ['boolean', 'object'],
        [doc]: 'Google Analytics plugin settings\nhttps://blog.zhangruipeng.me/hexo-theme-icarus/Plugins/General/site-analytics-plugin/#Google-Analytics',
        tracking_id: {
            [type]: 'string',
    ...
    'baidu-analytics': {
        [type]: ['boolean', 'object'],
        [doc]: 'Baidu Analytics plugin settings\nhttps://blog.zhangruipeng.me/hexo-theme-icarus/Plugins/General/site-analytics-plugin/#Baidu-Analytics',
        tracking_id: {
            [type]: 'string',
    ...
    hotjar: {
        [type]: ['boolean', 'object'],
        [doc]: 'Hotjar user feedback plugin\nhttps://blog.zhangruipeng.me/hexo-theme-icarus/Plugins/General/site-analytics-plugin/#Hotjar',
        site_id: {
            [type]: ['string', 'number'],
            [doc]: 'Hotjar site id',
            [defaultValue]: null
